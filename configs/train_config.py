...
parser = argparse.ArgumentParser(description="Training model for test code completion")
parser.add_argument('--model', default='meta-llama/CodeLlama-7b-hf', type=str, help='type of transformers model as model backbone')
parser.add_argument('--model_path', default=None, type=str, help='path to model backbone pretrained weights') 
parser.add_argument('--save_dir', default=None, type=str, help='path to save trained rltc model checkpoints') 

# Dataloading
parser.add_argument('--train-path', default='dataset/train/', type=str, help='path to training data')
